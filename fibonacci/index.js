 ...
 */
function fibonacci(nthPos) {
    // if (nthPos < 2 || nthPos === 5) {
    //     return nthPos
    // }
    // else {
    //     return fibonacci(nthPos-2) + fibonacci(nthPos-1)
    // }

    return (nthPos < 2 || nthPos === 5) ? nthPos : fibonacci(nthPos-2) + fibonacci(nthPos-1)
}
